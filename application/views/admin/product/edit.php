...
<section class="content container-fluid">
	<form action="<?= base_url($this->router->fetch_class().'/product_edit/'.$product['id']) ?>" method="post" enctype="multipart/form-data">
		<div class="box">
			...
			<div class="box-body">
				<div class="form-group">
					...
					<input class="form-control" type="text" name="name" placeholder="Nama Produk" value="<?= set_value('name', $product['name']) ?>">
					<?= form_error('name', '<span class="help-block error">', '</span>'); ?>
				</div>
				<div class="form-group">
					<label>Harga Produk</label>
					<input class="form-control" type="text" name="price" placeholder="Harga Produk" value="<?= set_value('price', $product['price']) ?>">
